 	...
 	stages
		{
				...
				steps
				{
					script
					{
						...
						//upload application
						def uploadFile = bat returnStdout: true, script: "curl -X POST -F \"file=@\\Users\\S0641\\Desktop\\Flight.apk\" -F \"source_type=raw\" -F \"token=${token}\" -F \"filter=all\" https://device.pcloudy.com/api/upload_file | C:\\Users\\S0641\\Desktop\\jq-win64.exe \".result.file\""
